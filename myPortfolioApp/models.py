...
class portfolio_details(models.Model):
    ...
    project_discriptions = models.TextField(blank=True, null=True)
    project_discriptions_html = models.TextField(blank=True, null=True)
...
class portfolio_features(models.Model):
    ...
    feature_discriptions = models.TextField(blank=True, null=True)
    feature_discriptions_html = models.TextField(blank=True, null=True)
    priority = models.CharField(max_length=100, blank=True, null=True)
    status = models.CharField(max_length=100, blank=True, null=True)
    skills = models.CharField(max_length=100, blank=True, null=True)
    date_finished = models.DateTimeField(null=True)
